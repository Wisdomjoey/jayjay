...
var odd1_12 = User.getProperty("odd1_12")
var odd2_12 = User.getProperty("odd2_12")
var odd3_12 = User.getProperty("odd3_12")
var odd4_12 = User.getProperty("odd4_12")
var odd5_12 = User.getProperty("odd5_12")
var odd6_12 = User.getProperty("odd6_12")
var odd7_12 = User.getProperty("odd7_12")
var odd8_12 = User.getProperty("odd8_12")
var odd9_12 = User.getProperty("odd9_12")
var odd10_12 = User.getProperty("odd10_12")
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m3+" vs "+m4+"\n_play_: _12_    _odd_: "+odds1+"\n","string")
User.setProperty("odd2_12",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m5+" vs "+m6+"\n_play_: _12_    _odd_: "+odds1+"\n","string")
User.setProperty("odd3_12",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m7+" vs "+m8+"\n_play_: _12_    _odd_: "+odds1+"\n","string")
User.setProperty("odd4_12",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m9+" vs "+m10+"\n_play_: _12_    _odd_: "+odds1+"\n","string")
User.setProperty("odd5_12",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m11+" vs "+m12+"\n_play_: _12_    _odd_: "+odds1+"\n","string")
User.setProperty("odd6_12",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m13+" vs "+m14+"\n_play_: _12_    _odd_: "+odds1+"\n","string")
User.setProperty("odd7_12",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m15+" vs "+m16+"\n_play_: _12_    _odd_: "+odds1+"\n","string")
User.setProperty("odd8_12",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m17+" vs "+m18+"\n_play_: _12_    _odd_: "+odds1+"\n","string")
User.setProperty("odd9_12",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
User.setProperty("odd10_12",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
