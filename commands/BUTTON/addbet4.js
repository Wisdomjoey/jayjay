...
var odd1_1X = User.getProperty("odd1_1X")
var odd2_1X = User.getProperty("odd2_1X")
var odd3_1X = User.getProperty("odd3_1X")
var odd4_1X = User.getProperty("odd4_1X")
var odd5_1X = User.getProperty("odd5_1X")
var odd6_1X = User.getProperty("odd6_1X")
var odd7_1X = User.getProperty("odd7_1X")
var odd8_1X = User.getProperty("odd8_1X")
var odd9_1X = User.getProperty("odd9_1X")
var odd10_1X = User.getProperty("odd10_1X")
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m3+" vs "+m4+"\n_play_: _1X_    _odd_: "+odds1+"\n","string")
User.setProperty("odd2_1X",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m5+" vs "+m6+"\n_play_: _1X_    _odd_: "+odds1+"\n","string")
User.setProperty("odd3_1X",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m7+" vs "+m8+"\n_play_: _1X_    _odd_: "+odds1+"\n","string")
User.setProperty("odd4_1X",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m9+" vs "+m10+"\n_play_: _1X_    _odd_: "+odds1+"\n","string")
User.setProperty("odd5_1X",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m11+" vs "+m12+"\n_play_: _1X_    _odd_: "+odds1+"\n","string")
User.setProperty("odd6_1X",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m13+" vs "+m14+"\n_play_: _1X_    _odd_: "+odds1+"\n","string")
User.setProperty("odd7_1X",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m15+" vs "+m16+"\n_play_: _1X_    _odd_: "+odds1+"\n","string")
User.setProperty("odd8_1X",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
if (betslip == undefined){
User.setProperty("betslip","______________________________\n          🎫 _BETSLIP_\nbetslip_id: _Gamotron_-_"+betrand+"_\n______________________________\n\n1. "+m17+" vs "+m18+"\n_play_: _1X_    _odd_: "+odds1+"\n","string")
User.setProperty("odd9_1X",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
...
User.setProperty("odd10_1X",1,"integer")
User.setProperty("oddn",odds1,"integer")
User.setProperty("manu",1,"integer")
User.setProperty("betslipid","_Gamotron_-_"+betrand,"string")
}else{
